...
**Play GLYPH (one click — GitHub Pages):**  
https://freestylegrapplerz-ez-brackets.github.io/tapout-tactics/glyph/index.html

Short link:  
https://freestylegrapplerz-ez-brackets.github.io/tapout-tactics/play-glyph.html

> Repo root (`/tapout-tactics/`) is Tapout Tactics (BJJ). GLYPH is in `/glyph/`.
